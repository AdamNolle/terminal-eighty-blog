...
export declare function isConvoRef<V>(v: V): v is import("../../../../util").$TypedObject<V, "chat.bsky.convo.defs", "convoRef">;
export declare function validateConvoRef<V>(v: V): ValidationResult<ConvoRef & V>;
